...
public class Connect extends AppCompatActivity {
    ...
    Button btnPaired, startGame, disconnect;
    ListView devicelist;
    TextView conn;
    ...
    private void send(String btn)
    {
        if (btSocket!=null)
        {
            ...
            {
                Toast.makeText(Connect.this, "Error", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private AdapterView.OnItemClickListener myListClickListener = new AdapterView.OnItemClickListener()
    {
        public void onItemClick (AdapterView av, View v, int arg2, long arg3)
        {
            ...
            Toast.makeText(Connect.this, "Connecting...", Toast.LENGTH_SHORT).show();
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        protected void onPostExecute(Void result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (!ConnectSuccess)
            {
                Toast.makeText(Connect.this, "Connection Failed", Toast.LENGTH_SHORT).show();
                conn.setText("Not Connected");
         ...
         //       disconnect.setVisibility(View.VISIBLE);
                conn.setText("Connected! Hit Start to play the game");
